...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 TVC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 TVC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 1005000000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 17280 / 250;
    }
